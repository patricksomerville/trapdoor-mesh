...
from security import TokenManager, ApprovalQueue
...
def register_approval_endpoints(
    ...
    def rotate_token(token_id: str, authorization: Optional[str] = Header(None)):
        """
    ...
    def disable_token(token_id: str, authorization: Optional[str] = Header(None)):
        """
        Disable a token
